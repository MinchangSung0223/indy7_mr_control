...
for t in np.arange(0,endTime,dt):
	...
	p.addUserDebugLine([r[0]+10*uf_nx[0],r[1]+10*uf_nx[1],r[2]+10*uf_nx[2]],[r[0]-10*uf_nx[0],r[1]-10*uf_nx[1],r[2]-10*uf_nx[2]],[1,0,0],1,dt*10,replaceItemUniqueId=x_lineId)
	p.addUserDebugLine([r[0]+10*uf_ny[0],r[1]+10*uf_ny[1],r[2]+10*uf_ny[2]],[r[0]-10*uf_ny[0],r[1]-10*uf_ny[1],r[2]-10*uf_ny[2]],[0,1,0],1,dt*10,replaceItemUniqueId=y_lineId)
	p.addUserDebugLine([r[0]+10*uf_nz[0],r[1]+10*uf_nz[1],r[2]+10*uf_nz[2]],[r[0]-10*uf_nz[0],r[1]-10*uf_nz[1],r[2]-10*uf_nz[2]],[0,0,1],1,dt*10,replaceItemUniqueId=z_lineId)	
